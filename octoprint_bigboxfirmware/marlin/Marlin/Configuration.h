...
#define STRING_CONFIG_H_AUTHOR "(Greg Holloway, Dual Hybrid)" //Modified by BigBoxFirmware Plugin
...
#define BAUDRATE 230400 //Modified by BigBoxFirmware Plugin
...
#define CUSTOM_MACHINE_NAME "BigBox 1.1 D" //Modified by BigBoxFirmware Plugin
...
#define HEATER_0_MAXTEMP 300 //Modified by BigBoxFirmware Plugin
#define HEATER_1_MAXTEMP 300 //Modified by BigBoxFirmware Plugin
...
#define INVERT_X_DIR true //Modified by BigBoxFirmware Plugin
#define INVERT_Y_DIR false //Modified by BigBoxFirmware Plugin
#define INVERT_Z_DIR false

// @section extruder

// For direct drive extruder v9 set to true, for geared extruder set to false.
#define INVERT_E0_DIR true //Modified by BigBoxFirmware Plugin
...
#define X_MIN_POS -38 //Modified by BigBoxFirmware Plugin
#define Y_MIN_POS 0
#define Z_MIN_POS 0
#define X_MAX_POS 300 //Modified by BigBoxFirmware Plugin
#define Y_MAX_POS 235 //Modified by BigBoxFirmware Plugin
...
//#define MESH_BED_LEVELING    // Enable mesh bed leveling.
  ...
  #define MESH_MIN_X 5 //Modified by BigBoxFirmware Plugin
  #define MESH_MAX_X (X_MAX_POS - (MESH_MIN_X))
  #define MESH_MIN_Y 5 //Modified by BigBoxFirmware Plugin
  #define MESH_MAX_Y (200 - (MESH_MIN_Y)) //Modified by BigBoxFirmware Plugin
...
#define AUTO_BED_LEVELING_FEATURE  //Modified by BigBoxFirmware Plugin
...
#define Z_MIN_PROBE_REPEATABILITY_TEST  // If not commented out, Z Probe Repeatability test will be included if Auto Bed Leveling is Enabled.
  ...
  #define AUTO_BED_LEVELING_GRID
    ...
    #define RIGHT_PROBE_BED_POSITION 265 //Modified by BigBoxFirmware Plugin
    #define FRONT_PROBE_BED_POSITION 15 //Modified by BigBoxFirmware Plugin
  ...
  #define Z_PROBE_OFFSET_FROM_EXTRUDER -2 //Modified by BigBoxFirmware Plugin

  #define XY_TRAVEL_SPEED 3000 //Modified by BigBoxFirmware Plugin

  #define Z_RAISE_BEFORE_PROBING 3 //Modified by BigBoxFirmware Plugin
  #define Z_RAISE_BETWEEN_PROBINGS 3 //Modified by BigBoxFirmware Plugin
  #define Z_RAISE_AFTER_PROBING 3 //Modified by BigBoxFirmware Plugin
...
// For deltabots this means top and center of the Cartesian print volume.
  ...
  #define MANUAL_X_HOME_POS -38 //Modified by BigBoxFirmware Plugin
...
#define HOMING_FEEDRATE {50*60, 50*60, 6*60, 0} //Modified by BigBoxFirmware Plugin

// default settings

#define DEFAULT_AXIS_STEPS_PER_UNIT {160,180,1600,417.5} //Modified by BigBoxFirmware Plugin
...
// Preheat Constants
#define PLA_PREHEAT_HOTEND_TEMP 220 //Modified by BigBoxFirmware Plugin
#define PLA_PREHEAT_HPB_TEMP 60 //Modified by BigBoxFirmware Plugin
#define PLA_PREHEAT_FAN_SPEED 0   // Insert Value between 0 and 255

#define ABS_PREHEAT_HOTEND_TEMP 240
#define ABS_PREHEAT_HPB_TEMP 120 //Modified by BigBoxFirmware Plugin
...
//
#define ENCODER_PULSES_PER_STEP 1 //Modified by BigBoxFirmware Plugin

//
// Use this option to override the number of step signals required to
// move between next/prev menu items.
//
#define ENCODER_STEPS_PER_MENU_ITEM 4 //Modified by BigBoxFirmware Plugin
...
#define LCD_FEEDBACK_FREQUENCY_HZ 500 //Modified by BigBoxFirmware Plugin
